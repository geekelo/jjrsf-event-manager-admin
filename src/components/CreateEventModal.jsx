...
import { faTimes, faSave, faCalendarCheck, faMapMarkerAlt, faGlobe, faClock } from '@fortawesome/free-solid-svg-icons';
          ...
          <div className="form-row">
            <div className="form-group">
              <label htmlFor="registration_deadline">
                <FontAwesomeIcon icon={faCalendarCheck} className="form-icon" /> Registration Deadline
              </label>
              <input
                type="date"
